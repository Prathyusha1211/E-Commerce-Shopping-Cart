...
const ProductCard = ({ product }) => {
  ...
  return (
    <div className="border p-5 rounded-md hover:shadow-lg transition-shadow duration-200 max-w-xs">
      ...
      <p className="text-gray-600 text-xs overflow-hidden whitespace-nowrap text-ellipsis">{product.description}</p>
      <div className="mt-1">
        <span className="text-md font-semibold text-black">${product.price.toFixed(2)}</span>
      ...
      <button
        ...
        className="bg-blue-600 text-white mt-2 px-3 py-1.5 rounded w-full hover:bg-blue-700 flex items-center justify-center"
      >
